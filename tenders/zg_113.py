...
from conf_113 import from_email, password, to_emails, bcc


BASE_URL = 'https://zakupki.gov.ru'
BASE_DIR = os.path.abspath(os.path.dirname(__file__))
DB_PATH = 'db\\zg_113.db'
...
def set_logger():
    root_logger = logging.getLogger('zg_113')
    handler = logging.FileHandler('logs\\zg_113.log', 'a', 'utf-8')
...
# print(res)
sending_email(save_results(res), 'zakupki-gov by INN')
# sending_email(save_results(res_kw))
